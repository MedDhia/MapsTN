...
**33 of the 60 Tunisian-side tribes in the gazetteer have at least one figure;
27 have none.**
...
| [Ganiage, *La population de la Tunisie vers 1860*](https://www.persee.fr/doc/pop_0032-4663_1966_num_21_5_13406) | 1966, on c. 1860 data | Reconstruction from the *mejba* poll-tax registers | taxpayers, converted to souls | Tribe, per the registers | Persée record open; full text not retrievable here |
...
**Ganiage 1966** is the one that would matter most for the 1881 map, because it
reconstructs population from the *mejba* poll-tax registers, which were kept
tribe by tribe, for a date between Pellissier and the protectorate. Persée serves
the record but not the text to this session, and the PDF endpoint refuses. The
citation is: Jean Ganiage, « La population de la Tunisie vers 1860. Essai
...
Of the 60 Tunisian-side gazetteer tribes, 27 have nothing: Aguerba, Chehida,
Hezil, Iddir, Khememsa, Makna, Mehabel, Mehadhba, Mekena, Meressen, Oulad Amer,
Oulad Khalifa, Ouled Redouan, Ouled Saïd, Ouled Soltan, Ouled Yakoub, Ouled el
Goussem, Regab, Riah, Taïfa, Trabelsi, and the six fractions that only the 1853
map names separately (five of the M'Talith, one of the Hammama).
